...
In this module, I have learnt that in industry, working in groups is largely unavoidable. Java continues to be annoying, but git is great. LaTeX is also great (I'm saying this just so that the compiler is not offended).
